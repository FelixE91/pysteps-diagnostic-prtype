...
To install pysteps-diagnostic-prtype, run this command in your terminal:
...
The latest development version of pysteps-diagnostic-prtype can be installed using
pip by running in a terminal::

    pip install git+https://github.com/YOUR_GITHUB_USERNAME/pysteps-diagnostic-prtype

Or, from a local copy of the repo::

    git clone https://github.com/YOUR_GITHUB_USERNAME/pysteps-diagnostic-prtype
    cd pysteps-diagnostic-prtype
    pip install .
